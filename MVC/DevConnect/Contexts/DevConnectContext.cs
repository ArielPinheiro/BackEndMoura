...
public partial class DevConnectContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentario).HasName("PK__tb_comen__1BA6C6F4A0DD7CC0");
        ...
        {
            entity.HasKey(e => e.IdCurtida).HasName("PK__tb_curti__0AC033CAC9B921B6");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_publi__3213E83FB10C1939");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tb_usuar__3213E83F5CA04F02");
            ...
            entity.HasMany(d => d.IdSeguindo).WithMany(p => p.IdUsuarioSeguidor)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("IdUsuarioSeguidor", "IdSeguindo").HasName("PK__tb_segui__44E9DBED281AECF1");
